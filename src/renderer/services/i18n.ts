...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    userSettingsImportEntryDesc: '从已有的 12 个助记词恢复用户身份',
    ...
    userSettingsImportProfileHint: '名字和头像仅当链上没有该账号资料时使用并发布；若链上已有资料，会自动使用链上的名字和头像。',
    userSettingsImportSubmit: '导入',
    userSettingsImporting: '导入中…',
    userSettingsImportSuccess: '导入成功',
    userSettingsErrorInvalidMnemonic: '助记词无效，请检查单词和顺序',
    userSettingsErrorChatPubkeyMismatch: '该账号链上已有不同的聊天公钥，通常是派生路径不对，请检查路径',
    userSettingsErrorNameEmptyImport: '链上没有该账号资料，请填写名字',
  ...
  en: {
    ...
    userSettingsImportEntryDesc: 'Restore your identity from 12 existing words',
    ...
    userSettingsImportProfileHint: 'Name and avatar are only used and published if the account has no profile on-chain; if one exists, the on-chain name and avatar are used automatically.',
    userSettingsImportSubmit: 'Import',
    userSettingsImporting: 'Importing…',
    userSettingsImportSuccess: 'Imported successfully',
    userSettingsErrorInvalidMnemonic: 'Invalid mnemonic. Check the words and their order.',
    ...
    userSettingsErrorNameEmptyImport: 'No on-chain profile found for this account. Please enter a name.',
