  ...
  return (
    <div className="rounded-xl border border-emerald-300/60 dark:border-emerald-500/30 bg-emerald-50/60 dark:bg-emerald-900/10 p-3 mb-3">
      ...
      {summary.members.length > 0 && (
        <div className="mt-2 text-[11px] dark:text-claude-darkTextSecondary/80 text-claude-textSecondary/80">
      ...
      <pre className="mt-2 whitespace-pre-wrap text-[11px] leading-relaxed dark:text-claude-darkTextSecondary text-claude-textSecondary font-sans">
