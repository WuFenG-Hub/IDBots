/**
 * Thin client for the metaso-p2p MetaWeb Q&A APIs
 * (metaso-p2p docs/specs/2026-09-07-metaweb-qa-api.md): GET /api/qa/search,
 * GET /api/qa/questions, GET /api/qa/questions/:pinId and
 * GET /api/qa/questions/:pinId/answers. Same conventions as the social
 * recall family: {code, data, message} envelope, HTTP always 200, business
 * error codes 40000/40400/50000, opaque cursors, no auth.
 *
 * Wire facts worth remembering (mirror of the contract):
